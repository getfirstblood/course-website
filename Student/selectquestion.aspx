<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="selectquestion.aspx.cs" Inherits="UserControls_selectquestion" Title="无标题页" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Topic] WHERE ([UserName] = @UserName)" 
        DeleteCommand="DELETE FROM [Topic] WHERE [TopicId] = @TopicId" 
        InsertCommand="INSERT INTO [Topic] ([Content], [UserName], [CreateTime], [Title]) VALUES (@Content, @UserName, @CreateTime, @Title)" 
        UpdateCommand="UPDATE [Topic] SET [Content] = @Content, [UserName] = @UserName, [CreateTime] = @CreateTime, [Title] = @Title WHERE [TopicId] = @TopicId">
        <SelectParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        Width="730px" DataKeyNames="TopicId">
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="TopicId" 
                DataNavigateUrlFormatString="replay.aspx?TopicId={0}" DataTextField="Title" 
                HeaderText="问题">
                <ItemStyle Width="75%" />
            </asp:HyperLinkField>
            <asp:BoundField DataField="CreateTime" HeaderText="时间" 
                SortExpression="CreatTime" />
