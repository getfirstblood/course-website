<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="replay.aspx.cs" Inherits="replay" Title="无标题页" %>

<%@ Register src="~/UserControls/replay.ascx" tagname="replay" tagprefix="uc1" %>

<%@ Register src="../UserControls/askanswer1.ascx" tagname="askanswer1" tagprefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
  <div id="reply">
<uc2:askanswer1 ID="askanswer11" runat="server" />
<uc1:replay ID="replay1" runat="server" /></div>
</ContentTemplate>
</asp:UpdatePanel>
</asp:Content>
