<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewScore.aspx.cs" Inherits="Student_ViewScore" Title="无标题页" %>

<%@ Register src="../UserControls/ScoresViewer.ascx" tagname="ScoresViewer" tagprefix="uc1" %>
...
<ContentTemplate>
    <uc1:ScoresViewer ID="ScoresViewer1" runat="server" />
    </ContentTemplate>
     </asp:UpdatePanel>   
</asp:Content>
