<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PracticeOnline.aspx.cs" Inherits="PracticeOnline" Title="无标题页" %>

<%@ Register src="../UserControls/Exam.ascx" tagname="Exam" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:Exam ID="Exam1" runat="server" />
</asp:Content>
