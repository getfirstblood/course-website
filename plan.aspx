<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="plan.aspx.cs" Inherits="plan" Title="教学日历 - 网络信息安全精品课程" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<script type="text/javascript">
  function openurl()
  {
     window.open('./Teacher/Edit.aspx?type=2','','width:850px;height:460px;');
  }
</script>
</asp:Content>
