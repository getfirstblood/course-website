<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="principles.aspx.cs" Inherits="principles" Title="教学大纲 - 网络信息安全精品课程" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<script type="text/javascript">
  function openurl()
  {
     window.open('./Teacher/Edit.aspx?type=1','','width:850px;height:460px;');
  }
</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
     <ContentTemplate>
     <asp:Button ID="btEdit" CssClass="btedit" runat="server" Text="编辑" OnClientClick="openurl()"/>
