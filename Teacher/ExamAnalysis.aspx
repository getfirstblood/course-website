<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExamAnalysis.aspx.cs" Inherits="Teacher_ExamAnalysis" Title="无标题页" %>

<%@ Register src="../UserControls/Report.ascx" tagname="Report" tagprefix="uc1" %>
