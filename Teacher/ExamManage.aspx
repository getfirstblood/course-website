<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExamManage.aspx.cs" Inherits="ExamManage" Title="无标题页" %>


<%@ Register src="~/UserControls/ctCreateExam.ascx" tagname="ctCreateExam" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <uc1:ctCreateExam ID="ctCreateExam1" runat="server" />
