<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CorrectOnline.aspx.cs" Inherits="Teacher_CorrectOnline" Title="无标题页" %>

<%@ Register src="../UserControls/Mark.ascx" tagname="Mark" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:Mark ID="Mark1" runat="server" />
</asp:Content>
