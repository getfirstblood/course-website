<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="inform.aspx.cs" Inherits="inform" Title="课程通知 - 网络信息安全精品课程" %>

<%@ Register src="UserControls/NewsList.ascx" tagname="NewsList" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<script type="text/javascript">
  function openurl()
  {
     window.open('./Teacher/Edit.aspx?type=3','','width:850px;height:460px');
  }
</script>
